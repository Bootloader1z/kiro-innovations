...
flowchart TD
    ...
    subgraph CONSTRUCTION["🟢 CONSTRUCTION PHASE"]
        ...
        TP["Test Planning<br/><b>EXECUTE</b>"]
...
- [ ] Infrastructure Design - [EXECUTE/SKIP]
  - **Rationale**: [Why executing or skipping]
- [ ] Test Planning - EXECUTE (ALWAYS)
  - **Rationale**: Formal test plan with scenarios and pass/fail criteria before code generation
