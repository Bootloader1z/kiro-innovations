...
- Test Plans must be approved for all units (used for pass/fail verification)
...
- **Load approved Test Plans** from `aidlc-docs/construction/{unit-name}/test-plan/test-plan.md` for each unit
- **Unit tests**: Already generated per unit during code generation (verify against Test Plan scenarios)
- **Integration tests**: Test interactions between units/services
- **Performance tests**: Load, stress, and scalability testing
- **End-to-end tests**: Complete user workflows
- **Contract tests**: API contract validation between services
- **Security tests**: Vulnerability scanning, penetration testing
- **Pass/Fail criteria**: Use each unit's Test Plan pass/fail criteria to determine build success
